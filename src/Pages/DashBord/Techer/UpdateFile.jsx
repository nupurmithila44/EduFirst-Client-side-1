...
const UpdateFile = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if(res.data.success){
            ...
            const menuRes =  await axiosSecure.patch(`/myClass/${_id}`, updateItem);
            ...
            if(menuRes.data.modifiedCount > 0){
                ...
                Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: `${data.name} id updated Items`,
                    showConfirmButton: false,
                    timer: 1500
                  });
            }
        }  
        console.log('with imge  url', res.data)   
       
      };
    return (
        <div className="my-10">
        <div className="">
            <h1 className="text-2xl text-center font-bold">Update class</h1>
